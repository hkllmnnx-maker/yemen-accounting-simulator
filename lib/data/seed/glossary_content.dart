...
const List<GlossaryTerm> glossary = [
  ...
  GlossaryTerm(
    term: 'الأصول',
    definition:
        'كل ما تملكه الشركة: نقدية، مخزون، سيارات، عقارات، عملاء (مدينون).',
  ),
  GlossaryTerm(
    term: 'الالتزامات',
    definition:
        'كل ما على الشركة من ديون: موردون (دائنون)، قروض، مصروفات مستحقة.',
  ),
  GlossaryTerm(
    term: 'حقوق الملكية',
  ...
  GlossaryTerm(
    term: 'المصروفات',
    definition:
        'كل المبالغ التي تُنفقها الشركة: إيجار، رواتب، كهرباء، تكلفة بضاعة.',
  ),
  GlossaryTerm(
    term: 'سند القبض',
    definition:
        'مستند يُسجل استلام مبلغ نقدي من عميل أو طرف، يزيد رصيد الصندوق/البنك.',
  ),
  GlossaryTerm(
    term: 'سند الصرف',
    definition:
        'مستند يُسجل دفع مبلغ نقدي لمورد أو طرف، يُنقص رصيد الصندوق/البنك.',
  ),
  GlossaryTerm(
  ...
  GlossaryTerm(
    term: 'حد الائتمان',
    definition:
        'الحد الأقصى المسموح به لمديونية العميل قبل تجميد التعامل الآجل.',
  ),
  GlossaryTerm(
    term: 'كشف الحساب',
    definition:
        'تقرير يُظهر جميع الحركات على حساب معيّن (عميل/مورد/بنك) خلال فترة، ورصيده الحالي.',
  ),
  GlossaryTerm(
    term: 'دفتر الأستاذ',
  ...
  GlossaryTerm(
    term: 'ميزان المراجعة',
    definition:
        'تقرير يُظهر كل الحسابات وأرصدتها للتأكد أن مجموع المدين = مجموع الدائن.',
  ),
  GlossaryTerm(
    term: 'قائمة الدخل',
    definition:
        'تقرير يُظهر الإيرادات والمصروفات وصافي الربح أو الخسارة لفترة معيّنة.',
  ),
  GlossaryTerm(
    term: 'المركز المالي (الميزانية)',
    definition:
        'تقرير يُظهر الأصول والالتزامات وحقوق الملكية في تاريخ معيّن. الأصول = الالتزامات + حقوق الملكية.',
  ),
  GlossaryTerm(
    term: 'الجرد',
    definition:
        'عدّ المخزون فعليًا ومقارنته بما يُظهره النظام، وتسوية أي فروق.',
  ),
  GlossaryTerm(
  ...
  GlossaryTerm(
    term: 'الترحيل',
    definition:
        'اعتماد القيد ليُؤثر على أرصدة الحسابات. القيد غير المُرحَّل لا يظهر في التقارير.',
  ),
  GlossaryTerm(
    term: 'السنة المالية',
    definition:
        'الفترة المحاسبية التي يتم خلالها إعداد التقارير، عادة 12 شهرًا.',
  ),
  GlossaryTerm(
    term: 'الفروع',
    definition:
        'مكاتب أو نقاط بيع تابعة للشركة الأم في مدن مختلفة (صنعاء، عدن، تعز...).',
  ),
];
