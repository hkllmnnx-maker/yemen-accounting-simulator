...
class FinAccountsCatalog {
  static const List<FinAccount> all = [
    // ========== الأصول المتداولة ==========
    FinAccount(
        id: 'cash', name: 'الصندوق', type: FinAccountType.asset),
    FinAccount(
        id: 'bank', name: 'البنك', type: FinAccountType.asset),
    FinAccount(
    ...
    FinAccount(
        ...
        type: FinAccountType.expense), // يُخصم من الإيرادات
    ...
    FinAccount(
        ...
        type: FinAccountType.revenue), // يُخصم من المشتريات
    FinAccount(
        id: 'misc_expense',
        name: 'مصروفات متنوعة',
        type: FinAccountType.expense),
